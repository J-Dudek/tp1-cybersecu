...
|Confidentialité 3/5|Intégrité 3/5|Disponibilité 4/5|Traçabilité 4/5|
|:-:|:-:|:-:|:-:|
|Une Personne non autorisée ayant accés à l'appliacation aurait pour cause une perte de confiance des utilisateurs |L'utilisateur souhaitant ajouter un livre ne doit pas pouvoir se retrouver avec un autre,cela fairait perdre l'utilité de l'application|Une indisponibilité de l'application engendrerai une pertes d'utilisateur donc perte de Chiffre d'Affaire|Une mauvaise traçabilité faciliterait le piratage et donc la perte de crédibilité auprès des utilisateurs.|
| Mise à part à un catalogue de livre aucune information personnelle n'est dans l'application (cf RGPD)  |Une modification/suppression de la base d'un utilisateur entrainerait une perte de CA||   |

-> En soit chaque faille aurait pour conséquence une perte de crédibilité auprès des utilisateurs ce qui entrainerait une mauvaise image de l'application pouvant mener à sa fin.
### Mesures mises en Oeuvres pour répondre aux objectifs:
